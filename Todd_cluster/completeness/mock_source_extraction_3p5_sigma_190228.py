...
hdulist = fits.open('./190911_wholemap/mock_'+str(random_flux_mJy_int[rf])+'mJy_'+cluster_list[l]+'_snr_170919.fits')      #================================================================================HERE
...
hdulist_flux = fits.open('./190911_wholemap/mock_'+str(random_flux_mJy_int[rf])+'mJy_'+cluster_list[l]+'_flux_170919.fits')      #================================================================================HERE
...
for k in range(0, len(pix_value_array)):
    ...
    if pix_value_array[k] >= 3.5:                           #================================================================================HERE: 3.5-sigma?
...
def floodfill(x,y):
    ...
    if scidata[0,y-1,x-1] < 3.5: # the base case      #================================================================================HERE: 3.5-sigma?
    #if scidata[y-1,x-1] < 3.5: # the base case      #================================================================================HERE: 3.5-sigma? (Orz) S2CLS

        return; 

    pix_value_array_3sigma_sorted_extract_tmp.append(scidata[0,y-1,x-1])
    scidata[0,y-1,x-1] = 0.0
...
#pix_value_flux_array_3sigma_sorted_extract_mJy=pix_value_flux_array_3sigma_sorted_extract*537.0*1000.0  #================================================================HERE (Orz) ordinary fields
pix_value_flux_array_3sigma_sorted_extract_mJy=pix_value_flux_array_3sigma_sorted_extract*1.0*1.0     #================================================================HERE (Orz) S2CLS or Todd's clusters
...
mock_catalogue=np.column_stack((pix_coor_x_3sigma_sorted_extract, pix_coor_y_3sigma_sorted_extract, ra_3sigma_sorted_extract, dec_3sigma_sorted_extract, pix_value_array_3sigma_sorted_extract, pix_value_flux_array_3sigma_sorted_extract, pix_value_flux_array_3sigma_sorted_extract_mJy, pix_value_flux_error_array_3igma_sorted_extract_mJy))

np.savetxt('./190911_wholemap/mock_'+str(random_flux_mJy_int[rf])+'mJy_'+cluster_list[l]+'_3p5sigma.cat', mock_catalogue, delimiter=' ', header="pix_x pix_y RA Dec SN_ratio flux_pW flux_mJy_perbeam flux_error_mJy") #================================================================================HERE



mock_catalogue_ds9=np.column_stack((ra_3sigma_sorted_extract, dec_3sigma_sorted_extract))

np.savetxt('./190911_wholemap/mock_'+str(random_flux_mJy_int[rf])+'mJy_'+cluster_list[l]+'_3p5sigma.reg', mock_catalogue_ds9, delimiter=' ') #================================================================================HERE
