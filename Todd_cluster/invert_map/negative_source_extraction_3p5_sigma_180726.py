...
hdulist = fits.open('../'+cluster_list[l]+'/mfsnr_crop.fits')      #================================================================================HERE
w = wcs.WCS(hdulist[0].header, hdulist)
naxis1=hdulist[0].header['NAXIS1']
naxis2=hdulist[0].header['NAXIS2']
scidata_tmp = hdulist[0].data
scidata = -scidata_tmp  #========================================make S/N negative here!
hdulist.close()

hdulist_flux = fits.open('../'+cluster_list[l]+'/mf_crop.fits')      #================================================================================HERE
...
pix_value_flux_error_array_3igma_sorted_extract_mJy=-pix_value_flux_array_3sigma_sorted_extract_mJy/pix_value_array_3sigma_sorted_extract  #==============add negative to make noise + back!
...
np.savetxt('./original_catalogues/'+cluster_list[l]+'_3p5sigma_negative.cat', mock_catalogue, delimiter=' ', header="pix_x pix_y RA Dec SN_ratio flux_pW flux_mJy_perbeam flux_error_mJy") #================================================================================HERE



mock_catalogue_ds9=np.column_stack((ra_3sigma_sorted_extract, dec_3sigma_sorted_extract))

np.savetxt('./original_catalogues/'+cluster_list[l]+'_3p5sigma_negative.reg', mock_catalogue_ds9, delimiter=' ') #================================================================================HERE
