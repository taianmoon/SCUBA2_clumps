...
hdulist = fits.open('./'+cluster_list[l]+'/mfsnr_crop.fits')      #================================================================================HERE (SN map)
...
hdulist_flux = fits.open('./'+cluster_list[l]+'/mf_crop.fits')      #================================================================================HERE (flux map)
...
#=======================Filter out sigma>3 or 3.5 pixels====================================================
...
#pix_value_flux_array_3sigma_sorted_extract_mJy=pix_value_flux_array_3sigma_sorted_extract*537.0*1000.0  #=================================================HERE: if flux map is pW
pix_value_flux_array_3sigma_sorted_extract_mJy=pix_value_flux_array_3sigma_sorted_extract*1.0*1.0      #=================================================HERE: if flux map is mJy/beam (Todd's cluster)
...
print pix_value_flux_array_3sigma_sorted_extract  #flux in original unit
...
for o in range(0, len(pix_coor_x_3sigma_sorted_extract)):
    ...
    s1, ignore = w.all_pix2world([[pix_coor_x_3sigma_sorted_extract[o],pix_coor_y_3sigma_sorted_extract[o],1],[0,0,0]],1)   #=========Check for different survey maps!!
...
#===============================================Stack all lists together and output source catalogue===========================
...
np.savetxt('./catalogues/original_190502/'+cluster_list[l]+'_3p5sigma.cat', mock_catalogue, delimiter=' ', header="name pix_x pix_y RA Dec SN_ratio flux_pW flux_mJy_perbeam flux_error_mJy") #================================================================================HERE



mock_catalogue_ds9=np.column_stack((ra_3sigma_sorted_extract, dec_3sigma_sorted_extract))

np.savetxt('./catalogues/original_190502/'+cluster_list[l]+'_3p5sigma.reg', mock_catalogue_ds9, delimiter=' ') #================================================================================HERE
