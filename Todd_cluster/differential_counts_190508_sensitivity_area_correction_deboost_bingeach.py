...
if cluster_list[l]=='S2CLS':
    ...
    template_file = open("./catalogues/edgesourcedelete_deboost_190502/"+cluster_list[l]+"_3p5sigma_deboost.cat", "r")   
...
if cluster_list[l]=='S2CLS':
    ...
    flux_mjy_err_pre=response_curve[:,13]    #=========================================================HERE: 8 for Todd's cluster, 7 for our clusters
    sn_ratio_pre=response_curve[:,12]     #=========================================================HERE: 5 for Todd's cluster, 4 for our clusters
    #sn_ratio_pre=response_curve[:,12]     #=========================================================HERE: 5 for Todd's cluster, 4 for our clusters #including confusion noise, but actually it's included
...
if cluster_list[l]=='S2CLS':
    ...
    noise_value_array_tmp=noise_value_array_tmp*1.0*1.0  #--> for Todd's fields, already in mJy
...
#========================Estimate differential number per deg^2 or per map size==========================
...
#ax.errorbar(geach_flux_widebin, bin_number_perarea, yerr=bin_number_perarea_err, color='blue',fmt='o', capsize=5, elinewidth=2,markeredgewidth=2) #Poisson errorbar =================HERE
ax.errorbar(geach_flux_widebin, bin_number_perarea, yerr=completeness_err, color='blue',fmt='o', capsize=5, elinewidth=2,markeredgewidth=2) #completeness errorbar =================HERE
...
#mock_catalogue=np.column_stack((geach_flux_widebin, bin_number_perarea))


if binsize==1:
    np.savetxt('./ncounts/diff_190626/diff_counts_'+cluster_list[l]+'_bin1.cat', mock_catalogue, delimiter=' ') #================================================================================HERE
if binsize==2:
    np.savetxt('./ncounts/diff_190626/diff_counts_'+cluster_list[l]+'_bin2.cat', mock_catalogue, delimiter=' ') #================================================================================HERE
