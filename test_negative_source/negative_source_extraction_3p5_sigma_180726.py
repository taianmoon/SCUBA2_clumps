...
hdulist = fits.open('../'+cluster_list[l]+'/'+cluster_list[l]+'_snr_170919.fits')      #================================================================================HERE
...
np.savetxt('./'+cluster_list[l]+'_3p5sigma_negative.cat', mock_catalogue, delimiter=' ', header="pix_x pix_y RA Dec SN_ratio flux_pW flux_mJy_perbeam flux_error_mJy") #================================================================================HERE



mock_catalogue_ds9=np.column_stack((ra_3sigma_sorted_extract, dec_3sigma_sorted_extract))

np.savetxt('./'+cluster_list[l]+'_3p5sigma_negative.reg', mock_catalogue_ds9, delimiter=' ') #================================================================================HERE
