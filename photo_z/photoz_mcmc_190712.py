...
for j in range(0, len(flux_250_observed)):  #looping different sources
#for j in range(0, 2):  #looping different sources

    
    y=[flux_250_observed[j], flux_350_observed[j], flux_500_observed[j], flux_850_observed[j]]
    yerr=[error_250_observed[j], error_350_observed[j], error_500_observed[j], error_850_observed[j]]
