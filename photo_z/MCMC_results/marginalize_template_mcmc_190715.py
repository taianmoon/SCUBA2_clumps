...
np.savetxt('./marginalized/luminosity_allsource_aless.cat', mock_catalogue_aless, delimiter=' ') #================================================================================HERE
...
np.savetxt('./marginalized/luminosity_allsource_arp220.cat', mock_catalogue_arp220, delimiter=' ') #================================================================================HERE
...
np.savetxt('./marginalized/luminosity_allsource_hfls3.cat', mock_catalogue_hfls3, delimiter=' ') #================================================================================HERE
...
np.savetxt('./marginalized/luminosity_allsource_eyelash.cat', mock_catalogue_eyelash, delimiter=' ') #================================================================================HERE
...
hist, bin_edges = np.histogram(z_distribution_all, bins=10, range=[0.0, 10.0])
#hist = np.array(hist)
...
plt.legend(loc=1)
plt.xlabel('Redshift')
plt.ylabel(r'Number of Sources ($arcmin^{-2}$)')
plt.rc('font', size=30)
plt.show()
...
hist_L, bin_edges_L = np.histogram(L_distribution_all, bins=100)

print hist_L

bin_edges_L = bin_edges_L[:-1]

bin_edges_true_L=[]
hist_true_L=[]
for i in range(0, len(bin_edges_L)):
    bin_edges_true_L.append(bin_edges_L[i])
    hist_true_L.append(hist_L[i]/(map_size_all*3600.0))   #divide by map size to get number per arcmin^2  ===================================HERE: becareful of other fields!

print bin_edges_true_L


fig_L = plt.figure()
plt.plot(bin_edges_true_L, hist_true_L, linewidth=1.5, label='This work')
plt.scatter(bin_edges_true_L, hist_true_L, s=80.0)
...
hist_SFR, bin_edges_SFR = np.histogram(SFR_distribution_all, bins=100)

print hist_SFR

bin_edges_SFR = bin_edges_SFR[:-1]

bin_edges_true_SFR=[]
hist_true_SFR=[]
for i in range(0, len(bin_edges_SFR)):
    bin_edges_true_SFR.append(bin_edges_SFR[i])
    hist_true_SFR.append(hist_SFR[i]/(map_size_all*3600.0))   #divide by map size to get number per arcmin^2  ===================================HERE: becareful of other fields!

print bin_edges_true_SFR


fig_SFR = plt.figure()
plt.plot(bin_edges_true_SFR, hist_true_SFR, linewidth=1.5, label='This work')
plt.scatter(bin_edges_true_SFR, hist_true_SFR, s=80.0)
