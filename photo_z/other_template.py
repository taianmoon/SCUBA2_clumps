...
for i in range(0, len(z_list)):
    for j in range(0, len(dely_list)):
        ...
        flux_500_z_aless.append(np.interp(500.0, wavelength_micron_z_aless, flux_mjy_z_aless))
...
for i in range(0, len(z_list)):
    for j in range(0, len(dely_list)):
        ...
        flux_500_z_hfls3.append(np.interp(500.0, wavelength_micron_z_hfls3, flux_mjy_z_hfls3))
...
for i in range(0, len(z_list)):
    for j in range(0, len(dely_list)):
        ...
        flux_500_z_eyelash.append(np.interp(500.0, wavelength_micron_z_eyelash, flux_mjy_z_eyelash))
