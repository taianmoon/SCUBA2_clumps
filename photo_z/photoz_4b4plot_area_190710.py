...
dely_list=np.logspace(-1.0, 1.0, num=200, endpoint=True, base=10.0)  #========================================================HERE: change parameter grids
...
#for i in range(9, 10):  #looping different sources
    ...
    for j in range(0, len(flux_250_z)):  #looping different parameters
        ...
        residual_squared_sum_eyelash.append((residual_squared_250_eyelash+residual_squared_350_eyelash+residual_squared_500_eyelash+residual_squared_850_eyelash))
        ...
        likelihood_sum_eyelash.append(math.exp(-0.5*(residual_squared_250_eyelash+residual_squared_350_eyelash+residual_squared_500_eyelash+residual_squared_850_eyelash)))
        likelihood_sum_marginalize.append(math.exp(-0.5*(residual_squared_250+residual_squared_350+residual_squared_500+residual_squared_850))+math.exp(-0.5*(residual_squared_250_aless+residual_squared_350_aless+residual_squared_500_aless+residual_squared_850_aless))+math.exp(-0.5*(residual_squared_250_hfls3+residual_squared_350_hfls3+residual_squared_500_hfls3+residual_squared_850_hfls3))+math.exp(-0.5*(residual_squared_250_eyelash+residual_squared_350_eyelash+residual_squared_500_eyelash+residual_squared_850_eyelash)))
    ...
    for o in range(0, len(flux_250_z_eyelash)):
