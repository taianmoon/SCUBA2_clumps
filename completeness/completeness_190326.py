...
for l in range(0, len(cluster_list)):    #================loop over clusters
    ...
    for rf in range(0, len(random_flux)):  #==================loop over different flux
        ...
        fname_mock = './'+cluster_list[l]+'/mock_'+str(random_flux_mJy_int[rf])+'mJy_'+cluster_list[l]+'_3p5sigma.cat'
        fname_orig = './original_cat/'+cluster_list[l]+'_3p5sigma.cat'
        ...
        if random_flux_mJy_int[rf] != 8 or rt != realization_times-1:
            os.remove('./'+cluster_list[l]+'/mock_'+str(random_flux_mJy_int[rf])+'mJy_'+cluster_list[l]+'_3p5sigma.cat')
            os.remove('./'+cluster_list[l]+'/mock_'+str(random_flux_mJy_int[rf])+'mJy_'+cluster_list[l]+'_flux_170919.fits')
            os.remove('./'+cluster_list[l]+'/mock_'+str(random_flux_mJy_int[rf])+'mJy_'+cluster_list[l]+'_snr_170919.fits')
            os.remove('./'+cluster_list[l]+'/mock_'+str(random_flux_mJy_int[rf])+'mJy_'+cluster_list[l]+'_3p5sigma.reg')
